  ...
  return `
    ...
    <body>
      <div class="container">
        ...
        <div class="footer">
          <p>This email was sent from the NAK IT Careers Application Form</p>
...
export default async function handler(req, res) {
  ...
  try {
    ...
    // Email options
    const mailOptions = {
      from: `"NAK IT Careers" <${process.env.GMAIL_USER}>`,
      to: process.env.MAIL_TO || 'careers@nakitgroup.com',
