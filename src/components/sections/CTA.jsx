...
export default function CTA() {
  ...
  return (
    <section ref={sectionRef} className="bg-gradient-to-br from-blue-700 via-blue-800 to-[#0d1a3a] py-24 relative overflow-hidden" id="contact">
      <div className="absolute inset-0 bg-[linear-gradient(rgba(255,255,255,0.03)_1px,transparent_1px),linear-gradient(90deg,rgba(255,255,255,0.03)_1px,transparent_1px)] bg-[size:50px_50px]" />
      <div className="cta-blob-1 absolute top-1/3 left-1/4 w-[500px] h-[400px] rounded-full bg-blue-400/10 blur-[100px] pointer-events-none" />
      ...
      <div className="max-w-5xl mx-auto px-6 relative text-center">
        <div className="cta-badge inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-white/10 border border-white/20 text-blue-100 text-xs font-semibold uppercase tracking-widest mb-8">
        ...
        <p className="cta-sub text-blue-100/80 text-lg md:text-xl max-w-2xl mx-auto leading-relaxed mb-10">
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-4 mb-16">
          <MagneticButton
            ...
            className="cta-btn w-full sm:w-auto px-8 py-4 rounded-full bg-white text-blue-700 font-bold text-base shadow-xl shadow-black/20"
          >
            Contact Us Now
          </MagneticButton>
          <MagneticButton
