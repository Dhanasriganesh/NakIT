          ...
          <div className="rounded-xl sm:rounded-2xl border border-white/60 bg-white/70 backdrop-blur-xl shadow-xl shadow-slate-200/50 p-5 sm:p-6 md:p-8 lg:p-10
            ...
            <form className="space-y-3 sm:space-y-4" onSubmit={(e) => e.preventDefault()}>
              <div className="grid sm:grid-cols-2 gap-3 sm:gap-4">
                <div>
                  ...
                  <input
                    type="text"
                    required
                    className="w-full rounded-lg sm:rounded-xl border border-slate-300/80 bg-white/80 backdrop-blur-sm px-3 sm:px-4 py-2 sm:py-2.5 text-slate-900 placeholder-slate-400 text-xs sm:text-sm focus:outline-none focus:border-nak-bright focus:ring-1 focus:ring-nak-bright transition-colors"
              ...
              <div>
                ...
                <textarea
                  rows={3}
                  className="w-full rounded-lg sm:rounded-xl border border-slate-300/80 bg-white/80 backdrop-blur-sm px-3 sm:px-4 py-2 sm:py-2.5 text-slate-900 placeholder-slate-400 text-xs sm:text-sm focus:outline-none focus:border-nak-bright focus:ring-1 focus:ring-nak-bright transition-colors resize-none"
              ...
              <div className="flex flex-col sm:flex-row gap-2 sm:gap-3 pt-1 sm:pt-2">
                <button
                  type="submit"
                  className="px-5 sm:px-6 py-2.5 sm:py-3 rounded-lg sm:rounded-xl bg-nak-deep hover:bg-nak-bright text-white text-xs sm:text-sm font-semibold shadow-lg shadow-nak-deep/30 hover:shadow-nak-bright/30 transition-all duration-300"
                >
                  Submit application
                </button>
                <NavLink
