...
export default function CareerHero() {
  return (
    <section className="relative min-h-[38vh] sm:min-h-[40vh] md:min-h-[42vh] overflow-hidden">
      ...
      <div className="relative z-10 container-app py-8 sm:py-10 md:py-14 lg:py-20">
        ...
        <div className="flex flex-wrap gap-2 sm:gap-3 text-[10px] sm:text-xs text-slate-100">
