...
const services = [
  { icon: (<svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M3 6l3 1m0 0l-3 9a5.002 5.002 0 006.001 0M6 7l3 9M6 7l6-2m6 2l3-1m-3 1l-3 9a5.002 5.002 0 006.001 0M18 7l3 9m-3-9l-6-2m0-2v2m0 16V5m0 16H9m3 0h3" /></svg>), title: 'Financial Services', description: 'Secure, compliant, and scalable systems for banking, insurance, and financial institutions.', tags: ['Banking', 'InsurTech', 'Compliance'], iconBg: 'bg-nak-bright/20', iconColor: 'text-nak-deep', tagBg: 'bg-nak-bright/10 text-nak-deep border-nak-bright/30', accent: '#1a498e' },
  ...
  { icon: (<svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M13 10V3L4 14h7v7l9-11h-7z" /></svg>), title: 'Energy', description: 'Smart energy management and renewable solutions for sustainable power infrastructure.', tags: ['Renewable', 'Smart Grid', 'IoT'], iconBg: 'bg-nak-bright/20', iconColor: 'text-nak-deep', tagBg: 'bg-nak-bright/10 text-nak-deep border-nak-bright/30', accent: '#2eafe6' },
      ...
      cards.forEach((card) => {
        ...
        card.addEventListener('mousemove', (e) => {
          ...
          gsap.to(card, {
            ...
            scale: 1.03,
            boxShadow: `${-x * 10}px ${-y * 10}px 30px rgba(26,73,142,0.15), 0 8px 32px rgba(0,0,0,0.08)`,
            duration: 0.25,
            ease: 'power2.out',
          })
        ...
        <div className="services-grid grid md:grid-cols-2 lg:grid-cols-3 gap-6" style={{ perspective: '1200px' }}>
          {services.map((service) => (
            ...
            >
              ...
              <h3 className="text-slate-900 font-bold text-lg mb-3 group-hover:text-nak-deep transition-colors duration-200">
                {service.title}
              </h3>
